...
import uniandes.isis2304.parranderos.negocio.DisponibilidadHabitaciones;
import uniandes.isis2304.parranderos.negocio.Parranderos;
import uniandes.isis2304.parranderos.negocio.VOClienteEmail;
import uniandes.isis2304.parranderos.negocio.VOClienteGeneral;
import uniandes.isis2304.parranderos.negocio.VOCuenta;
import uniandes.isis2304.parranderos.negocio.VODisponibilidadHabitaciones;
import uniandes.isis2304.parranderos.negocio.VOReservaHabitacion;
		...
		try {
			...
			if(nombreCliente != null && tipoDocumento != null && numeroDocumento != null && email != null && fechaInicio != null && fechaFin != null && cantPersonas != null) {
				...
				else
				{
					...
					VOClienteGeneral tb = parranderos.adicionarClienteGeneral(nombreCliente, tipoDocumento, numeroDocumento, email);
					VOClienteEmail tb2 = parranderos.adicionarClienteEmail(tipoDocumento, numeroDocumento, email);
					if(tb == null || tb2 == null) {
					...
					List <VODisponibilidadHabitaciones> disponibilidad = parranderos.darVODisponibilidadHabitaciones(tipHabitacion);
					...
					BigDecimal habitacion = parranderos.darDisponibilidadHabitaciones(tipHabitacion);
					...
					VOReservaHabitacion reserva = parranderos.adicionarReserva(fechaInicioTimestamp, fechaFinTimestamp, numPersonas, planPago, habitacion,idServicioHab, recepTipoDoc, recepNumDoc);
	...
	*****************************************************/
	public void registrarLlegadaCliente()
	{
		try {
			...
			BigDecimal cuenta = parranderos.adicionarCuentaBig();
			...
			VOReservaHabitacion reserva = parranderos.abrirCuentaReserva(idReserva, cuenta);
